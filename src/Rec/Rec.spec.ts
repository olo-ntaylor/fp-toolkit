...
describe("Rec", () => {
    ...
    describe("containsKey", () => {
        ...
        it("ignores undefined keys", () => {
            expect(
                pipe(
                    { Foobar: undefined } as Rec<string, number>,
                    Rec.containsKey("Foobar")
                )
            ).toBe(false)
        })
    ...
    describe("findKey", () => {
        ...
        it("ignores keys with manually-set undefined bindings", () => {
            expect(
                pipe(
                    { a: undefined } as Rec<string, number>,
                    Rec.findKey(() => true)
                )
            ).toBe(Option.none)
        })
    ...
    describe("remove", () => {
        it("ignores object keys that were manually set to undefined", () => {
            expect(
                pipe({ a: undefined } as Rec<string, number>, Rec.remove("a"))
            ).toStrictEqual({ a: undefined })
        })
    ...
    describe("iter", () => {
        ...
        it("ignores object keys that were manually set to undefined", () => {
            ...
            // act
            pipe(
                { a: undefined, b: undefined, c: 50 } as Rec<string, number>,
                Rec.iter(fn)
            )
            // assert
    ...
    describe("size", () => {
        ...
        it("does not count object keys that are manually set to undefined", () => {
            expect(
                pipe(
                    { a: undefined, b: undefined, c: 100 } as Rec<
                        string,
                        number
                    >,
                    Rec.size
    ...
    describe("keys", () => {
        it("ignores object keys with undefined values", () => {
            expect(
                pipe(
                    { a: undefined, b: undefined, c: 100, d: 1 } as Rec<
                        string,
                        number
                    >,
                    Rec.keys()
    ...
    describe("toArray", () => {
        ...
        it("ignores object entries with undefined values", () => {
            expect(
                pipe(
                    { b: 2, d: undefined, c: 3, a: undefined } as Rec<
                        string,
                        number
                    >,
                    Rec.toArray()
